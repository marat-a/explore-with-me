...
CREATE TYPE event_state AS ENUM ('PENDING', 'PUBLISHED', 'CANCELED', 'REJECTED', 'CONFIRMED');
...
CREATE TABLE IF NOT EXISTS events_compilation (
                                                  ...
                                                  CONSTRAINT FK_EVENTS_COMPILATION_ON_EVENT FOREIGN KEY (events_id) REFERENCES events (id),
